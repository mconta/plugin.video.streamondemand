...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR azure]Cinemalibero[/COLOR]"          , channel="cinemalibero"           , language="IT"    , category="B,F,S,A,VOS"   , type="generic",thumbnail="http://www.cinemalibero.com/wp-content/themes/crazystreaming/logo/logo.png"))
