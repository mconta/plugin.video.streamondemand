...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR azure][pre-release] Solo-Streaming[/COLOR]"      , channel="solostreaming"           , language="IT"    , category="B,F,S,A,VOS"   , type="generic",thumbnail="http://solo-streaming.com/images/sod/logo_solo_streaming.png"))
